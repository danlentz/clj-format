(defproject com.github.danlentz/clj-format "0.1.2"
  :description "An extensible Clojure DSL for cl-format, inspired by Hiccup. Drop-in compatibility. The power of FORMAT made easy."
  :author       "Dan Lentz"
  ...
  :dependencies [[org.clojure/clojure "1.12.2" :scope "provided"]
                 [com.github.danlentz/clj-figlet "0.1.4" :scope "provided"]]
